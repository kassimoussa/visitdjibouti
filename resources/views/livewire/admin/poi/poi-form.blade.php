<div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('translations.' . $activeLocale . '.short_description') is-invalid @enderror"
                                            id="short_description_{{ $activeLocale }}" wire:model="translations.{{ $activeLocale }}.short_description"
                                            rows="2"></textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('translations.' . $activeLocale . '.description') is-invalid @enderror"
                                            id="description_{{ $activeLocale }}" wire:model="translations.{{ $activeLocale }}.description" rows="6"
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3" wire:ignore>
                                        ...
                                        <div class="border rounded"
                                            ...
                                            <div id="poiLocationMap"
                                                style="height: 300px; width: 100%; min-height: 300px; min-width: 200px;">
                                            </div>
                                        </div>
                                        <div class="form-text">
                                    ...
                                    @if ($activeLocale === 'fr')
                                        <!-- Recherche d'adresse -->
                                        <div class="mb-3">
                                            <label for="poiAddressSearch" class="form-label">Rechercher une
                                                adresse</label>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                <label for="opening_hours_{{ $activeLocale }}"
                                                    class="form-label">Horaires
                                                    d'ouverture</label>
                                                <textarea class="form-control @error('translations.' . $activeLocale . '.opening_hours') is-invalid @enderror"
                                                    id="opening_hours_{{ $activeLocale }}" wire:model="translations.{{ $activeLocale }}.opening_hours"
                                                    rows="3"></textarea>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                <label for="entry_fee_{{ $activeLocale }}" class="form-label">Prix
                                                    d'entrée</label>
                                                <input type="text"
                                    ...
                                    <div class="mb-3">
                                        <label for="tips_{{ $activeLocale }}" class="form-label">Conseils aux
                                            visiteurs</label>
                                        <textarea class="form-control @error('translations.' . $activeLocale . '.tips') is-invalid @enderror"
                                            id="tips_{{ $activeLocale }}" wire:model="translations.{{ $activeLocale }}.tips" rows="3"></textarea>
                                                    ...
                                                    <h2 class="accordion-header"
                                                        ...
                                                        <button class="accordion-button collapsed" type="button"
                                                            ...
                                                            <span class="badge me-3"
                                                                ...
                                                                <i
                                                                    class="{{ $parentCategory->icon ?? 'fas fa-folder' }}"></i>
                                                            </span>
        ...
        return $translation ? $translation->name : '';
                                                    ...
                                                    @foreach ($selectedCategories as $categoryId)
                                                        ...
                                                        @if ($selectedCategory)
                                                            <span class="badge rounded-pill"
                                                                ...
                                                                <i
                                                                    class="{{ $selectedCategory->icon ?? 'fas fa-folder' }} me-1"></i>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    @else
                                        <div class="text-center py-4 border-dashed rounded"
                                                        ...
                                                        <div class="col-4 col-md-3 col-lg-2"
                                                            ...
                                                            <div class="gallery-item position-relative">
                                                                    ...
                                                                    <div class="image-overlay">
                                                                        <div class="overlay-actions">
                                                                            <button type="button"
                                                                                ...
                                                                                <i
                                                                                    class="fas fa-star {{ $featuredImageId == $mediaId ? 'text-warning' : 'text-muted' }}"></i>
                                                                            </button>
                                                                            <button type="button"
                                                                ...
                                                                <div class="mt-2 text-center">
                                                                    ...
                                                                    <span
                                                                        class="badge badge-sm bg-primary">{{ $index + 1 }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                                ...
                                                <div class="contact-item border rounded p-3 mb-3 position-relative"
                                                    ...
                                                    <div class="d-flex align-items-start">
                                                        <div class="contact-type-badge me-3 d-flex align-items-center justify-content-center rounded-circle"
                                                            ...
                                                            <i
                                                                class="{{ $this->getContactTypeIcon($contact['type'] ?? 'general') }} fa-lg"></i>
                                                        </div>
                                    ...
                                    @else
                                        <div class="text-center py-5 border-dashed rounded"
                                            style="border: 2px dashed #dee2e6;">
                                            <i class="fas fa-address-book fa-4x text-muted mb-3"></i>
                                            <h6 class="text-muted mb-3">Aucun contact ajouté</h6>
                                            <p class="text-muted mb-3">Ajoutez des contacts pour faciliter la prise de
                                                contact avec ce POI</p>
                        ...
                        <div class="card-body">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                                        <div class="d-flex align-items-center">
                                                            <div class="service-type-badge rounded-circle d-flex align-items-center justify-content-center me-3"
                                                                ...
                                                                <i
                                                                    class="{{ $this->getServiceTypeIcon($serviceType) }} text-white"></i>
                                                            </div>
                                                            <div>
                                                                <h6 class="mb-0">
                                                                    {{ $tourOperator?->getTranslatedName($activeLocale) ?? 'Tour operator introuvable' }}
                                                                </h6>
                                                            ...
                                                            @if ($tourOperator->website)
                                                                <div class="d-flex align-items-center mb-1">
                                                                    <i class="fas fa-globe me-2"
                                                                        style="width: 16px;"></i>
                                                                    <a href="{{ $tourOperator->website_url }}"
                                                            ...
                                                            @if (!empty($tourOperatorData['notes']))
                                                                <div class="mt-2">
                                                                    <i class="fas fa-sticky-note me-2"
                                                                        style="width: 16px;"></i>
                                                                    <small
                                                                        class="fst-italic">{{ $tourOperatorData['notes'] }}</small>
                                                                </div>
                                                            @endif
                                                        </div>
                                                    @endif
                            ...
                            @else
                                <div class="text-center py-5 border-dashed rounded"
                                    ...
                                    <p class="text-muted mb-3">Associez des tour operators pour enrichir l'expérience
                                        des visiteurs</p>
                                    <button type="button" class="btn btn-success"
                                        wire:click="openTourOperatorModal">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" wire:click="cancelContactEdit"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text"
                                ...
                                wire:model="modalContact.name" placeholder="Ex: Restaurant Le Palmier" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('modalContact.type') is-invalid @enderror"
                                wire:model="modalContact.type" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="tel"
                                ...
                                wire:model="modalContact.phone" placeholder="+253 77 XX XX XX">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email"
                                ...
                                wire:model="modalContact.email" placeholder="contact@example.com">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text"
                                ...
                                wire:model="modalContact.address" placeholder="Ex: Avenue Hassan Gouled, Djibouti">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('modalContact.description') is-invalid @enderror"
                                wire:model="modalContact.description" rows="3" placeholder="Spécialités, services, horaires..."></textarea>
                        ...
                        <div class="col-12">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" wire:model="modalContact.is_primary"
                                    id="modalContactPrimary">
                                <label class="form-check-label" for="modalContactPrimary">
                                    <strong>Contact principal</strong>
                                    <div class="form-text">Ce contact sera mis en avant et considéré comme le contact
                                        principal du POI</div>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    @if (!empty($modalContact['type']) && $modalContact['type'])
                        <div class="alert alert-info mt-3">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <strong>Aperçu du type:</strong>
                                    {{ $this->getContactTypes()[$modalContact['type']] ?? 'Type inconnu' }}
                                </div>
                            </div>
                        </div>
                    @endif
                    ...
                    @if (config('app.debug'))
                        <div class="alert alert-secondary mt-2">
                            <small>
                                <strong>Debug:</strong>
                                Mode:
                                {{ $editingContactIndex !== null ? 'Edition (index: ' . $editingContactIndex . ')' : 'Ajout' }}
                                |
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" wire:click="saveContact"
                        data-editing-index="{{ $editingContactIndex }}" id="saveContactButton">
                        @if ($editingContactIndex !== null)
    ...
    <div class="modal fade" id="tourOperatorModal" tabindex="-1" aria-labelledby="tourOperatorModalLabel"
        wire:ignore.self>
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" wire:click="cancelTourOperatorEdit"
                        aria-label="Close"></button>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <select
                                class="form-select @error('modalTourOperator.tour_operator_id') is-invalid @enderror"
                                wire:model="modalTourOperator.tour_operator_id" required>
                            ...
                            @if ($tourOperators->isEmpty())
                                <div class="form-text text-warning">
                                    ...
                                    <a href="{{ route('tour-operators.create') }}" target="_blank"
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('modalTourOperator.service_type') is-invalid @enderror"
                                wire:model="modalTourOperator.service_type" required>
                        ...
                        <div class="col-md-6 d-flex align-items-end">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox"
                                    wire:model="modalTourOperator.is_primary" id="modalTourOperatorPrimary">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('modalTourOperator.notes') is-invalid @enderror"
                                wire:model="modalTourOperator.notes" rows="3"
                            ...
                            <div class="col-12">
                                <div class="alert alert-info d-flex align-items-center">
                                    <div class="service-type-preview rounded-circle d-flex align-items-center justify-content-center me-3"
                                        ...
                                        <i
                                            class="{{ $this->getServiceTypeIcon($modalTourOperator['service_type']) }} text-white"></i>
                                    </div>
                                    <div>
                                        <strong>{{ $this->getServiceTypes()[$modalTourOperator['service_type']] ?? $modalTourOperator['service_type'] }}</strong>
                                        <div class="small">Ce tour operator proposera ce type de service pour ce POI
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        document.addEventListener('livewire:init', function() {
            ...
            if (tourOperatorModalElement) {
                ...
                tourOperatorModalElement.addEventListener('hidden.bs.modal', function() {
                    ...
                    // Remettre le focus sur un élément approprié
                    const addTourOperatorBtn = document.querySelector(
                        '[wire\\:click="openTourOperatorModal"]');
            ...
            document.addEventListener('livewire:morph-start', function() {
                ...
                tourOperatorModalWasOpen = tourOperatorModalElement && tourOperatorModalElement.classList
                    .contains('show');
            });

            document.addEventListener('livewire:morph-end', function() {
                // Si le modal tour operator était ouvert et qu'il s'est fermé, le rouvrir
                if (tourOperatorModalWasOpen && tourOperatorModal && !tourOperatorModalElement.classList
                    .contains('show')) {
                    setTimeout(() => {
                        tourOperatorModal.show();
                    }, 100);
